...
<form action="./Image/event/upload.php" method  ="POST" enctype="multipart/form-data" style="border:1px solid #ccc">
    <div class="container">
        <h1>Add Event</h1>
        ...
        <div>
            <label for="temps"><b>Heure de début de l'activité(h:m)</b></label>
            <input type="time" placeholder="Length of the activity" name="time_activity"  required>
        </div>
        ...
        <label for="role"><b>Role</b></label><br>
            <input type="radio" name="size" value="small"> Small Event(0 to 50 people)<br>
            <input type="radio" name="size" value="medium"> Medium Event(50 to 150 people)<br>
            <input type="radio" name="size" value="big"> Big Event (More than 150 people)<br>
        </div>
