<!--####################################
header modifié pour que les liens fonctionne depuis le dossier boutique
 #######################################-->
    ...
    <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" <?php if($currentPage == "/galerie.php") {echo "active";} ?>href="../galery.php">Galerie</a>
        </div>
    </ul>
