...
echo "<div id='carousel' class='carousel slide' data-ride='carousel'>
    <div class='carousel-inner'>
        <div class='carousel-item active'>
            ...
            <img class='d-block w-100' src='Boutique/image_temp/".$data1['goodies_photo']."' alt='Produit le plus commandé'>
            </a>
        </div>
        <div class='carousel-item '>
            <a href='Boutique/template_produit.php?id=".$data2['goodies_id']."'>
            <img class='d-block w-100' src='Boutique/image_temp/".$data2['goodies_photo']."' alt='2eme produit le plus commandé'>
            </a>
        </div>
        <div class='carousel-item '>
            <a href='Boutique/template_produit.php?id=".$data3['goodies_id']."'>
            <img class='d-block w-100' src='Boutique/image_temp/".$data3['goodies_photo']."' alt='3eme produit le plus commandé'>
            </a>
        </div>
    </div>
